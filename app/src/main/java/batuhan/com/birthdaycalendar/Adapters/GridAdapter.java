...
public class GridAdapter extends ArrayAdapter {
    ...
    private List<BirthdayModel> allEvents;
    private BirthdayDAO dao;

    public GridAdapter(Context context, List<Date> monthlyDates, Calendar currentDate , List<BirthdayModel> allEvents) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for(int i = 0; i < allEvents.size(); i++){
            dao = new BirthdayDAO();
            eventCalendar.setTime(dao.convertStringToDate(allEvents.get(i).getBirthdayDate()));
