...
public class CalendarCustomView extends ConstraintLayout {
   ...
   /* private TextView txtDateDay;
    ...
    private void initializeUILayout(){
        ...
        previousButton = (Button)view.findViewById(R.id.btnPrev);
        nextButton = (Button) view.findViewById(R.id.btnNext);
        currentDate = (TextView)view.findViewById(R.id.txtDisplayDate);
        addEventButton = (Button)view.findViewById(R.id.today_button);
    ...
    public void setUpCalendarAdapter(){
        ...
        List<BirthdayModel> mEvents = new BirthdayDAO().getAllFutureEvents(vt);
